...
-- Không dùng Config.Item.Unique nên bỏ phần auto detect inventory
...
local locales = LoadLocales(Config.DefaultLocale or "vi")
local defaultLocales
if Config.DefaultLocale ~= "vi" then
    defaultLocales = LoadLocales("vi")
else
    defaultLocales = {}
end
