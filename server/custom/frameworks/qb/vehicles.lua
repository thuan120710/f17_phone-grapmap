...
function GetPlayerVehicles(source)
    ...
    for i = 1, #vehicles do
        ...
        local garageNames = {
            [0] = "Ngoài gara",
            [1] = {
                ["legionsquare"] = "Garage trung tâm",
                ["apartments"] = "Garage 382",
                ["casino"] = "Garage casino",
                ["samac"] = "Garage sa mạc",
                ["goc12h"] = "Garage 12h",
                ["gara348"] = "Garage 348",
                ["garafood"] = "Garage Grab Food",
                ["garatrangtrai"] = "Garage trang trại",
                ["garacauca"] = "Garage câu cá",
                ["garavanchuyen"] = "Garage vận chuyển",
                ["pdgarage"] = "Garage CS Thành phố 1",
                ["pdgarage2"] = "Garage CS Thành phố 2",
                ["pdsamac1"] = "Garage CS Sa mạc 1",
                ["pdsamac2"] = "Garage CS Sa mạc 2",
                ["pdpaleto"] = "Garage CS Paleto",
                ["bvthanhpho"] = "Garage BV Thành phố 1",
                ["bvthanhpho1"] = "Garage BV Thành phố 2",
                ["bvsamac1"] = "Garage BV Sa mạc 1",
                ["bvsamac2"] = "Garage BV Sa mạc 2",
                ["bvpaleto"] = "Garage BV Paleto",
                ["xxgarage"] = "Xưởng xe 4ANHZAI",
                ["xxpublic"] = "Xưởng xe 4ANHZAI",
                ["quanan"] = "Nhà hàng Le'Dino",
                ["quanbar"] = "Bar Tân Long",
                ["quannuoc"] = "Cà phê Molly",
                ["sanbay"] = "Sân bay",
            },
            [2] = "Bãi giam",
            [3] = "Chợ xe",
        ...
        local state
        local garage = vehicle.garage

        if garageNames[vehicle.state] then
            if type(garageNames[vehicle.state]) == "table" then
                if garageNames[vehicle.state][garage] then
                    state = garageNames[vehicle.state][garage]
                else
                    state = "Nhà #"..garage
                end
            else
                state = garageNames[vehicle.state]
            end
        else
            state = garage or "Garage"
        end
