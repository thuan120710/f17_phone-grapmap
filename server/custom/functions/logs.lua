...
local function GetAvatar(source)
    ...
    if discord and DISCORD_TOKEN then
        ...
        PerformHttpRequest(""..discord, function(status, response)
            if status == 200 then
    ...
    elseif steam then
        ...
        PerformHttpRequest(""..tonumber(steam, 16), function(status, response)
            if status == 200 then
    ...
    elseif fivem then
        ...
        PerformHttpRequest(""..fivem, function(statusCode, response, headers)
...
local function LogToDiscord(source, action, level, title, metadata, image)
	...
	local embed = {
		...
		footer = {
			text = "F17 Phone",
			icon_url = "https://media.discordapp.net/attachments/1008372897695404042/1369276368591917126/F17launcher_icon.png?ex=694c78be&is=694b273e&hm=ae0a4d047ef79822d08ed6a8d570d37edb0fb430e672c2c4bbb5b72ce33f7e71&=&format=webp&quality=lossless&width=461&height=461"
		}
	}
	...
	PerformHttpRequest(LOGS[action], function() end, "POST", json.encode({
		username = "F17 Phone",
        avatar_url = "https://media.discordapp.net/attachments/1008372897695404042/1369276368591917126/F17launcher_icon.png?ex=694c78be&is=694b273e&hm=ae0a4d047ef79822d08ed6a8d570d37edb0fb430e672c2c4bbb5b72ce33f7e71&=&format=webp&quality=lossless&width=461&height=461",
		embeds = { embed }
