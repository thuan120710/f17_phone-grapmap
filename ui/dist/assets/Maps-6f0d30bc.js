...
function Ei(t, e) {
    ...
    b.useEffect(function () {
        e !== i.current && t.attributionControl != null && (i.current != null && t.attributionControl.removeAttribution(i.current), e != null && t.attributionControl.addAttribution(e)), i.current = e
    }, [t, e])
}
const So = 1;
...
const Ai = b.createContext(null),
    zi = Ai.Provider;

function Fe() {
    const t = b.useContext(Ai);
    if (t == null) throw new Error("No context provided: useLeafletContext() can only be used in a descendant of <MapContainer>");
    return t
}
...
function Eo(t) {
    function e(i, n) {
        ...
        return b.useImperativeHandle(n, () => o), i.children == null ? null : Ce.createElement(zi, {
            value: s
        }, i.children)
    }
...
function Ao(t) {
    function e(i, n) {
        ...
        b.useImperativeHandle(n, () => r), b.useEffect(function () {
            o && r.update()
        }, [r, o, i.children]);
        const a = r._contentNode;
        return a ? Jn.createPortal(i.children, a) : null
    }
    return b.forwardRef(e)
}
...
function zo(t) {
    function e(i, n) {
        ...
        return b.useImperativeHandle(n, () => o), null
    }
    return b.forwardRef(e)
}
...
function Ii(t, e) {
    const i = b.useRef();
    b.useEffect(function () {
        return e != null && t.instance.on(e), i.current = e,
            function () {
...
function Io(t, e) {
    return function (n, o) {
        const s = Fe(),
            r = t(We(n, s), s);
        return Ei(s.map, n.attribution), Ii(r.current, n.eventHandlers), e(r.current, s, n, o), r
    }
}
var Zo = "1.9.1";
...
function w(t) {
    return "_leaflet_id" in t || (t._leaflet_id = ++Zi), t._leaflet_id
}
...
function E(t, e) {
    Object.prototype.hasOwnProperty.call(t, "options") || (t.options = t.options ? ue(t.options) : {});
...
function Ni(t, e) {
    return t.replace(ko, function (i, n) {
        var o = e[n];
...
var se = "data:image/gif;base64,R0lGODlhAQABAAD/ACwAAAAAAQABAAACADs=";
...
function Ri(t) {
    var e = +new Date,
        i = Math.max(0, 16 - (e - yi));
    return yi = e + i, window.setTimeout(t, i)
}
var Me = window.requestAnimationFrame || Se("RequestAnimationFrame") || Ri,
    Di = window.cancelAnimationFrame || Se("CancelAnimationFrame") || Se("CancelRequestAnimationFrame") || function (t) {
        window.clearTimeout(t)
    };

function W(t, e, i) {
    if (i && Me === Ri) t.call(e);
    else return Me.call(window, O(t, e))
}
...
lt.extend = function (t) {
    ...
    return t.statics && T(e, t.statics), t.includes && (No(t.includes), T.apply(null, [n].concat(t.includes))), T(n, t), delete n.statics, delete n.includes, n.options && (n.options = i.options ? ue(i.options) : {}, T(n.options, t.options)), n._initHooks = [], n.callInitHooks = function () {
...
var q = {
    ...
    _propagateEvent: function (t) {
        for (var e in this._eventParents) this._eventParents[e].fire(t.type, T({
            layer: t.target,
...
function _(t, e, i) {
    return t instanceof p ? t : $(t) ? new p(t[0], t[1]) : t == null ? t : typeof t == "object" && "x" in t && "y" in t ? new p(t.x, t.y) : new p(t, e, i)
}
...
z.prototype = {
    extend: function (t) {
        var e, i;
        if (!t) return this;
        if (t instanceof p || typeof t[0] == "number" || "x" in t) e = i = _(t);
    ...
    contains: function (t) {
        var e, i;
        return typeof t[0] == "number" || t instanceof p ? t = _(t) : t = F(t), t instanceof z ? (e = t.min, i = t.max) : e = i = t, e.x >= this.min.x && i.x <= this.max.x && e.y >= this.min.y && i.y <= this.max.y
    },
...
U.prototype = {
    extend: function (t) {
        var e = this._southWest,
            i = this._northEast,
            n, o;
        if (t instanceof C) n = t, o = t;
        else if (t instanceof U) {
            if (n = t._southWest, o = t._northEast, !n || !o) return this
        } else return t ? this.extend(S(t) || R(t)) : this;
        return !e && !i ? (this._southWest = new C(n.lat, n.lng), this._northEast = new C(o.lat, o.lng)) : (e.lat = Math.min(n.lat, e.lat), e.lng = Math.min(n.lng, e.lng), i.lat = Math.max(o.lat, i.lat), i.lng = Math.max(o.lng, i.lng)), this
    },
    pad: function (t) {
        var e = this._southWest,
            i = this._northEast,
        ...
        return new U(new C(e.lat - n, e.lng - o), new C(i.lat + n, i.lng + o))
    },
    getCenter: function () {
    ...
    contains: function (t) {
        typeof t[0] == "number" || t instanceof C || "lat" in t ? t = S(t) : t = R(t);
        var e = this._southWest,
            i = this._northEast,
            n, o;
...
function S(t, e, i) {
    return t instanceof C ? t : $(t) && typeof t[0] != "object" ? t.length === 3 ? new C(t[0], t[1], t[2]) : t.length === 2 ? new C(t[0], t[1]) : null : t == null ? t : typeof t == "object" && "lat" in t ? new C(t.lat, "lng" in t ? t.lng : t.lon, t.alt) : e === void 0 ? null : new C(t, e, i)
}
var ot = {
        ...
        wrapLatLng: function (t) {
            var e = this.wrapLng ? Ht(t.lng, this.wrapLng, !0) : t.lng,
                i = this.wrapLat ? Ht(t.lat, this.wrapLat, !0) : t.lat,
                n = t.alt;
            return new C(i, e, n)
        },
    ...
    Oe = {
        ...
        project: function (t) {
            var e = Math.PI / 180,
                ...
                o = Math.sin(n * e);
            return new p(this.R * t.lng * e, this.R * Math.log((1 + o) / (1 - o)) / 2)
        },
        unproject: function (t) {
            var e = 180 / Math.PI;
...
function Fi(t, e) {
    ...
    for (n = 0, s = t.length; n < s; n++) {
        for (a = t[n], o = 0, r = a.length; o < r; o++) h = a[o], i += (o ? "L" : "M") + h.x + " " + h.y;
        i += e ? d.svg ? "z" : "x" : ""
    }
    return i || "M0 0"
}
var qe = document.documentElement.style,
    ...
    Do = pe && !document.addEventListener,
    Wi = "msLaunchUri" in navigator && !("documentMode" in document),
    je = nt("webkit"),
    Ui = nt("android"),
    Gi = nt("android 2") || nt("android 3"),
    Ho = parseInt(/WebKit\/([0-9]+)|$/.exec(navigator.userAgent)[1], 10),
    Fo = Ui && nt("Google") && Ho < 537 && !("AudioNode" in window),
    Ke = !!window.opera,
    Vi = !Wi && nt("chrome"),
    qi = nt("gecko") && !je && !Ke && !pe,
    Wo = !Vi && nt("safari"),
    ji = nt("phantom"),
    Ki = "OTransition" in qe,
    Uo = navigator.platform.indexOf("Win") === 0,
    Yi = pe && "transition" in qe,
    Ye = "WebKitCSSMatrix" in window && "m11" in new window.WebKitCSSMatrix && !Gi,
    Xi = "MozPerspective" in qe,
    Go = !window.L_DISABLE_3D && (Yi || Ye || Xi) && !Ki && !ji,
    Kt = typeof orientation < "u" || nt("mobile"),
    Vo = Kt && je,
    qo = Kt && Ye,
    $i = !window.PointerEvent && window.MSPointerEvent,
    Ji = !!(window.PointerEvent || $i),
    Qi = "ontouchstart" in window || !!window.TouchEvent,
    jo = !window.L_NO_TOUCH && (Qi || Ji),
    Ko = Kt && Ke,
    Yo = Kt && qi,
    Xo = (window.devicePixelRatio || window.screen.deviceXDPI / window.screen.logicalXDPI) > 1,
    $o = function () {
        var t = !1;
        try {
    ...
    Xe = !!(document.createElementNS && Hi("svg").createSVGRect),
    Qo = !!Xe && function () {
    ...
    es = navigator.platform.indexOf("Mac") === 0,
    is = navigator.platform.indexOf("Linux") === 0;
...
var d = {
    ...
    tn = d.msPointer ? "MSPointerDown" : "pointerdown",
    en = d.msPointer ? "MSPointerMove" : "pointermove",
    nn = d.msPointer ? "MSPointerUp" : "pointerup",
    on = d.msPointer ? "MSPointerCancel" : "pointercancel",
    Ee = {
        touchstart: tn,
        touchmove: en,
        touchend: nn,
...
function ns(t, e, i) {
    return e === "touchstart" && as(), wi[e] ? (i = wi[e].bind(this, i), t.addEventListener(Ee[e], i, !1), i) : (console.warn("wrong event specified:", e), L.Util.falseFn)
}
...
function as() {
    Li || (document.addEventListener(tn, ss, !0), document.addEventListener(en, rs, !0), document.addEventListener(nn, bi, !0), document.addEventListener(on, bi, !0), Li = !0)
}
...
function hs(t, e) {
    e.MSPOINTER_TYPE_TOUCH && e.pointerType === e.MSPOINTER_TYPE_TOUCH && H(e), re(t, e)
}
...
var $e = ve(["transform", "webkitTransform", "OTransform", "MozTransform", "msTransform"]),
    Rt = ve(["webkitTransition", "transition", "OTransition", "MozTransition", "msTransition"]),
    sn = Rt === "webkitTransition" || Rt === "OTransition" ? Rt + "End" : "transitionend";
...
function v(t, e) {
    if (t.classList !== void 0)
        for (var i = Pt(e), n = 0, o = i.length; n < o; n++) t.classList.add(i[n]);
    else if (!Je(t, e)) {
        var s = ge(t);
        Qe(t, (s ? s + " " : "") + e)
    }
...
function I(t, e) {
    t.classList !== void 0 ? t.classList.remove(e) : Qe(t, Ue((" " + ge(t) + " ").replace(" " + e + " ", " ")))
}
...
function St(t, e, i) {
    var n = e || new p(0, 0);
    t.style[$e] = (d.ie3d ? "translate(" + n.x + "px," + n.y + "px)" : "translate3d(" + n.x + "px," + n.y + "px,0)") + (i ? " scale(" + i + ")" : "")
}

function B(t, e) {
    t._leaflet_pos = e, d.any3d ? St(t, e) : (t.style.left = e.x + "px", t.style.top = e.y + "px")
}
...
var Ut, Gt, Te;
if ("onselectstart" in document) Ut = function () {
    m(window, "selectstart", H)
}, Gt = function () {
    M(window, "selectstart", H)
};
else {
    var Bt = ve(["userSelect", "WebkitUserSelect", "OUserSelect", "MozUserSelect", "msUserSelect"]);
    Ut = function () {
        if (Bt) {
        ...
        Bt && (document.documentElement.style[Bt] = Te, Te = void 0)
    }
}

function ti() {
    m(window, "dragstart", H)
}
...
function ii(t) {
    ...
    t.style && (ce(), ae = t, Ae = t.style.outline, t.style.outline = "none", m(window, "keydown", ce))
}

function ce() {
    ae && (ae.style.outline = Ae, ae = void 0, Ae = void 0, M(window, "keydown", ce))
}
...
function M(t, e, i, n) {
    if (arguments.length === 1) Ti(t), delete t[tt];
    else if (e && typeof e == "object")
        for (var o in e) Ze(t, o, e[o], i);
    else if (e = Pt(e), arguments.length === 2) Ti(t, function (a) {
        return Ge(e, a) !== -1
    });
    else
        for (var s = 0, r = e.length; s < r; s++) Ze(t, e[s], i, n);
    return this
}
...
function Ie(t, e, i, n) {
    ...
    var s = function (a) {
        ...
        r = s;
    !d.touchNative && d.pointer && e.indexOf("touch") === 0 ? s = ns(t, e, s) : d.touch && e === "dblclick" ? s = cs(t, s) : "addEventListener" in t ? e === "touchstart" || e === "touchmove" || e === "wheel" || e === "mousewheel" ? t.addEventListener(ze[e] || e, s, d.passiveEvents ? {
        passive: !1
    } : !1) : e === "mouseenter" || e === "mouseleave" ? (s = function (a) {
        a = a || window.event, si(t, a) && r(a)
    }, t.addEventListener(ze[e], s, !1)) : t.addEventListener(e, r, !1) : t.attachEvent("on" + e, s), t[tt] = t[tt] || {}, t[tt][o] = s
}
...
function Ze(t, e, i, n, o) {
    ...
    var s = t[tt] && t[tt][o];
    if (!s) return this;
    !d.touchNative && d.pointer && e.indexOf("touch") === 0 ? os(t, e, s) : d.touch && e === "dblclick" ? fs(t, s) : "removeEventListener" in t ? t.removeEventListener(ze[e] || e, s, !1) : t.detachEvent("on" + e, s), t[tt][o] = null
}
...
function oi(t) {
    return Ie(t, "wheel", wt), this
}

function Yt(t) {
    return m(t, "mousedown touchstart dblclick contextmenu", wt), t._leaflet_disable_click = !0, this
}
...
function un(t, e) {
    ...
    return new p((t.clientX - n.left) / i.x - e.clientLeft, (t.clientY - n.top) / i.y - e.clientTop)
}
var ms = d.linux && d.chrome ? window.devicePixelRatio : d.mac ? window.devicePixelRatio * 3 : window.devicePixelRatio > 0 ? 2 * window.devicePixelRatio : 1;

function ln(t) {
    return d.edge ? t.wheelDeltaY / 2 : t.deltaY && t.deltaMode === 0 ? -t.deltaY / ms : t.deltaY && t.deltaMode === 1 ? -t.deltaY * 20 : t.deltaY && t.deltaMode === 2 ? -t.deltaY * 60 : t.deltaX || t.deltaZ ? 0 : t.wheelDelta ? (t.wheelDeltaY || t.wheelDelta) / 2 : t.detail && Math.abs(t.detail) < 32765 ? -t.detail * 20 : t.detail ? t.detail / -32765 * 60 : 0
}
    ...
    x = qt.extend({
        ...
        initialize: function (t, e) {
            e = E(this, e), this._handlers = [], this._layers = {}, this._zoomBoundLayers = {}, this._sizeChanged = !0, this._initContainer(t), this._initLayout(), this._onResize = O(this._onResize, this), this._initEvents(), e.maxBounds && this.setMaxBounds(e.maxBounds), e.zoom !== void 0 && (this._zoom = this._limitZoom(e.zoom)), e.center && e.zoom !== void 0 && this.setView(S(e.center), e.zoom, {
                reset: !0
            }), this.callInitHooks(), this._zoomAnimated = Rt && d.any3d && !d.mobileOpera && this.options.zoomAnimation, this._zoomAnimated && (this._createAnimProxy(), m(this._proxy, sn, this._catchTransitionEnd, this)), this._addLayers(this.options.layers)
        },
        ...
        fitBounds: function (t, e) {
            if (t = R(t), !t.isValid()) throw new Error("Bounds are not valid.");
        ...
        flyTo: function (t, e, i) {
            if (i = i || {}, i.animate === !1 || !d.any3d) return this.setView(t, e, i);
            this._stop();
            ...
            function c(Z) {
                var ne = Z ? -1 : 1,
                    Kn = Z ? h : a,
                    Yn = h * h - a * a + ne * f * f * u * u,
                    Xn = 2 * Kn * f * u,
                    be = Yn / Xn,
                    gi = Math.sqrt(be * be + 1) - be,
                    $n = gi < 1e-9 ? -18 : Math.log(gi);
                return $n
            }
            ...
            function rt(Z) {
                return a * (N(V) / N(V + l * Z))
            }

            function at(Z) {
                return a * (N(V) * G(V + l * Z) - g(V)) / f
            }
            ...
            var ft = Date.now(),
                ie = (c(1) - V) / l,
                jn = i.duration ? 1e3 * i.duration : 1e3 * ie * .8;

            function pi() {
                var Z = (Date.now() - ft) / jn,
                    ne = ee(Z) * ie;
                Z <= 1 ? (this._flyToFrame = W(pi, this), this._move(this.unproject(n.add(o.subtract(n).multiplyBy(at(ne) / u)), r), this.getScaleZoom(a / rt(ne), r), {
                    flyTo: !0
                })) : this._move(t, e)._moveEnd(!0)
            }
            return this._moveStart(!0, i.noMoveStart), pi.call(this), this
        },
        ...
        invalidateSize: function (t) {
            ...
            var i = this.getSize(),
                ...
                s = n.subtract(o);
            return !s.x && !s.y ? this : (t.animate && t.pan ? this.panBy(s) : (t.pan && this._rawPanBy(s), this.fire("move"), t.debounceMoveend ? (clearTimeout(this._sizeTimer), this._sizeTimer = setTimeout(O(this.fire, this, "moveend"), 200)) : this.fire("moveend")), this.fire("resize", {
                oldSize: e,
                newSize: i
            }))
        },
        ...
        remove: function () {
            ...
            this._locationWatchId !== void 0 && this.stopLocate(), this._stop(), A(this._mapPane), this._clearControlPos && this._clearControlPos(), this._resizeRequest && (K(this._resizeRequest), this._resizeRequest = null), this._clearHandlers(), this._loaded && this.fire("unload");
            var t;
        ...
        getBoundsZoom: function (t, e, i) {
            ...
            var n = this.getZoom() || 0,
                ...
                l = d.any3d ? this.options.zoomSnap : 1,
                f = h.x / u.x,
                c = h.y / u.y,
                g = e ? Math.max(f, c) : Math.min(f, c);
            return n = this.getScaleZoom(g, n), l && (n = Math.round(n / (l / 100)) * (l / 100), n = e ? Math.ceil(n / l) * l : Math.floor(n / l) * l), Math.max(o, Math.min(s, n))
        },
        getSize: function () {
        ...
        _initLayout: function () {
            ...
            this._fadeAnimated = this.options.fadeAnimation && d.any3d, v(t, "leaflet-container" + (d.touch ? " leaflet-touch" : "") + (d.retina ? " leaflet-retina" : "") + (d.ielt9 ? " leaflet-oldie" : "") + (d.safari ? " leaflet-safari" : "") + (this._fadeAnimated ? " leaflet-fade-anim" : ""));
            var e = Wt(t, "position");
        ...
        _onResize: function () {
            K(this._resizeRequest), this._resizeRequest = W(function () {
                this.invalidateSize({
                    debounceMoveend: !0
                })
            }, this)
        ...
        _findEventTargets: function (t, e) {
            for (var i = [], n, o = e === "mouseout" || e === "mouseover", s = t.target || t.srcElement, r = !1; s;) {
                ...
                if (n && n.listens(e, !0) && (o && !si(s, t) || (i.push(n), o)) || s === this._container) break;
                s = s.parentNode
            }
        ...
        _fireDOMEvent: function (t, e, i) {
            ...
            if (o.length) {
                ...
                for (r = 0; r < o.length; r++)
                    if (o[r].fire(e, h, !0), h.originalEvent._stopped || o[r].options.bubblingMouseEvents === !1 && Ge(this._mouseEvents, e) !== -1) return
            }
        },
        ...
        _limitZoom: function (t) {
            var e = this.getMinZoom(),
                i = this.getMaxZoom(),
                n = d.any3d ? this.options.zoomSnap : 1;
        ...
        _destroyAnimProxy: function () {
            A(this._proxy), this.off("load moveend", this._animMoveEnd, this), delete this._proxy
        },
...
var X = lt.extend({
        ...
        remove: function () {
            return this._map ? (A(this._container), this.onRemove && this.onRemove(this._map), this._map.off("unload", this.remove, this), this._map = null, this) : this
        },
...
x.include({
    ...
    _clearControlPos: function () {
        ...
        A(this._controlContainer), delete this._controlCorners, delete this._controlContainer
    }
});
var fn = X.extend({
        options: {
        ...
        expand: function () {
            ...
            return t < this._section.clientHeight ? (v(this._section, "leaflet-control-layers-scrollbar"), this._section.style.height = t + "px") : I(this._section, "leaflet-control-layers-scrollbar"), this._checkDisabledLayers(), this
        },
        collapse: function () {
        ...
        _initLayout: function () {
            ...
            e.setAttribute("aria-haspopup", !0), Yt(e), oi(e);
            var n = this._section = P("section", t + "-list");
            i && (this._map.on("click", this.collapse, this), m(e, {
                mouseenter: function () {
                    m(n, "click", H), this.expand(), setTimeout(function () {
                        M(n, "click", H)
                    })
                },
            ...
            o.href = "#", o.title = "Layers", o.setAttribute("role", "button"), m(o, "click", H), m(o, "focus", this.expand, this), i || this.expand(), this._baseLayersList = P("div", t + "-base", n), this._separator = P("div", t + "-separator", n), this._overlaysList = P("div", t + "-overlays", n), e.appendChild(n)
        },
        _getLayer: function (t) {
            for (var e = 0; e < this._layers.length; e++)
                if (this._layers[e] && w(this._layers[e].layer) === t) return this._layers[e]
        },
        _addLayer: function (t, e, i) {
            this._map && t.on("add remove", this._onLayerChange, this), this._layers.push({
                ...
                name: e,
                overlay: i
            }), this.options.sortLayers && this._layers.sort(O(function (n, o) {
        ...
        _onInputClick: function () {
            ...
            for (var s = t.length - 1; s >= 0; s--) e = t[s], i = this._getLayer(e.layerId).layer, e.checked ? n.push(i) : e.checked || o.push(i);
    ...
    ri = X.extend({
        ...
        _createButton: function (t, e, i, n, o) {
            var s = P("a", i, n);
            return s.innerHTML = t, s.href = "#", s.title = e, s.setAttribute("role", "button"), s.setAttribute("aria-label", e), Yt(s), m(s, "click", Ot), m(s, "click", o, this), m(s, "click", this._refocusOnMap, this), s
        },
        _updateDisabled: function () {
            var t = this._map,
                e = "leaflet-disabled";
            I(this._zoomInButton, e), I(this._zoomOutButton, e), this._zoomInButton.setAttribute("aria-disabled", "false"), this._zoomOutButton.setAttribute("aria-disabled", "false"), (this._disabled || t._zoom === t.getMinZoom()) && (v(this._zoomOutButton, e), this._zoomOutButton.setAttribute("aria-disabled", "true")), (this._disabled || t._zoom === t.getMaxZoom()) && (v(this._zoomInButton, e), this._zoomInButton.setAttribute("aria-disabled", "true"))
        }
    });
x.mergeOptions({
    zoomControl: !0
...
var ys = function (t) {
    ...
    Ps = '<svg aria-hidden="true" xmlns="http://www.w3.org/2000/svg" width="12" height="8" viewBox="0 0 12 8" class="leaflet-attribution-flag"><path fill="#4C7BE1" d="M0 0h12v4H0z"/><path fill="#FFD500" d="M0 4h12v3H0z"/><path fill="#E0BC00" d="M0 7h12v1H0z"/></svg>',
    ai = X.extend({
        options: {
            position: "bottomright",
            prefix: '<a href="https://leafletjs.com" title="A JavaScript library for interactive maps">' + (d.inlineSvg ? Ps + " " : "") + "Leaflet</a>"
        },
        initialize: function (t) {
            E(this, t), this._attributions = {}
        },
        onAdd: function (t) {
            t.attributionControl = this, this._container = P("div", "leaflet-control-attribution"), Yt(this._container);
...
var Ls = {
    ...
    Ci = d.touch ? "touchstart mousedown" : "mousedown",
    dt = qt.extend({
        options: {
            clickTolerance: 3
        },
        ...
        enable: function () {
            this._enabled || (m(this._dragStartTarget, Ci, this._onDown, this), this._enabled = !0)
        },
        disable: function () {
            this._enabled && (dt._dragging === this && this.finishDrag(!0), M(this._dragStartTarget, Ci, this._onDown, this), this._enabled = !1, this._moved = !1)
        },
        _onDown: function (t) {
            if (this._enabled && (this._moved = !1, !Je(this._element, "leaflet-zoom-anim"))) {
                if (t.touches && t.touches.length !== 1) {
                    dt._dragging === this && this.finishDrag();
                    return
                }
                if (!(dt._dragging || t.shiftKey || t.which !== 1 && t.button !== 1 && !t.touches) && (dt._dragging = this, this._preventOutline && ii(this._element), ti(), Ut(), !this._moving)) {
                    this.fire("down");
                    var e = t.touches ? t.touches[0] : t,
                        i = an(this._element);
                    this._startPoint = new p(e.clientX, e.clientY), this._startPos = Mt(this._element), this._parentScale = ni(i);
        ...
        _onMove: function (t) {
            if (this._enabled) {
                ...
                !i.x && !i.y || Math.abs(i.x) + Math.abs(i.y) < this.options.clickTolerance || (i.x /= this._parentScale.x, i.y /= this._parentScale.y, H(t), this._moved || (this.fire("dragstart"), this._moved = !0, v(document.body, "leaflet-dragging"), this._lastTarget = t.target || t.srcElement, window.SVGElementInstance && this._lastTarget instanceof window.SVGElementInstance && (this._lastTarget = this._lastTarget.correspondingUseElement), v(this._lastTarget, "leaflet-drag-target")), this._newPos = this._startPos.add(i), this._moving = !0, this._lastEvent = t, this._updatePosition())
            }
        },
        ...
        finishDrag: function (t) {
            I(document.body, "leaflet-dragging"), this._lastTarget && (I(this._lastTarget, "leaflet-drag-target"), this._lastTarget = null), M(document, "mousemove touchmove", this._onMove, this), M(document, "mouseup touchend touchcancel", this._onUp, this), ei(), Gt(), this._moved && this._moving && this.fire("dragend", {
                noInertia: t,
                distance: this._newPos.distanceTo(this._startPos)
            }), this._moving = !1, dt._dragging = !1
        }
    });
...
function ke(t, e, i, n, o) {
    var s = 0,
        r, a, h;
    for (a = n + 1; a <= o - 1; a++) h = $t(t[a], t[n], t[o], !0), h > s && (r = a, s = h);
    s > i && (e[r] = 1, ke(t, e, i, n, r), ke(t, e, i, r, o))
}

function Cs(t, e) {
    for (var i = [t[0]], n = 1, o = 0, s = t.length; n < s; n++) Ss(t[n], t[o]) > e && (i.push(t[n]), o = n);
...
function pn(t, e, i, n, o) {
    ...
    for (Si = r;;) {
        if (!(s | r)) return [t, e];
        if (s & r) return !1;
        a = s || r, h = fe(t, e, a, i, o), u = Lt(h, i), a === s ? (t = h, s = u) : (e = h, r = u)
    }
}
...
function gn(t) {
    return console.warn("Deprecated use of _flat, please use L.LineUtil.isFlat instead."), Y(t)
}

function vn(t, e) {
    var i, n, o, s, r, a, h, u;
    if (!t || t.length === 0) throw new Error("latlngs not passed");
    Y(t) || (console.warn("latlngs are not flat! Only the first ring will be used"), t = t[0]);
    var l = [];
    for (var f in t) l.push(e.project(S(t[f])));
    var c = l.length;
    for (i = 0, n = 0; i < c - 1; i++) n += l[i].distanceTo(l[i + 1]) / 2;
    if (n === 0) u = l[0];
    else
        for (i = 0, s = 0; i < c - 1; i++)
...
function yn(t, e, i) {
    var n, o = [1, 4, 2, 8],
        s, r, a, h, u, l, f, c;
    for (s = 0, l = t.length; s < l; s++) t[s]._code = Lt(t[s], e);
    for (a = 0; a < 4; a++) {
        for (f = o[a], n = [], s = 0, l = t.length, r = l - 1; s < l; r = s++) h = t[s], u = t[r], h._code & f ? u._code & f || (c = fe(u, h, f, e, i), c._code = Lt(c, e), n.push(c)) : (u._code & f && (c = fe(u, h, f, e, i), c._code = Lt(c, e), n.push(c)), n.push(h));
        t = n
    }
    return t
}
...
function xn(t, e) {
    ...
    Y(t) || (console.warn("latlngs are not flat! Only the first ring will be used"), t = t[0]);
    var f = [];
    for (var c in t) f.push(e.project(S(t[c])));
    var g = f.length;
    for (a = h = u = 0, i = 0, n = g - 1; i < g; n = i++) o = f[i], s = f[n], r = o.y * s.x - s.y * o.x, h += (o.x + s.x) * r, u += (o.y + s.y) * r, a += r * 3;
...
var Os = {
    ...
    Be = {
        ...
        unproject: function (t) {
            for (var e = 180 / Math.PI, i = this.R, n = this.R_MINOR / i, o = Math.sqrt(1 - n * n), s = Math.exp(-t.y / i), r = Math.PI / 2 - 2 * Math.atan(s), a = 0, h = .1, u; a < 15 && Math.abs(h) > 1e-7; a++) u = o * Math.sin(r), u = Math.pow((1 - u) / (1 + u), o / 2), h = Math.PI / 2 - 2 * Math.atan(s * u) - r, r += h;
            return new C(r * e, t.x * e / i)
        }
    },
    Pn = {
        __proto__: null,
    ...
    wn = T({}, pt, {
        code: "EPSG:4326",
        projection: hi,
        transformation: jt(1 / 180, 1, -1 / 180, .5)
    }),
    As = T({}, ot, {
        projection: hi,
...
var Et = J.extend({
    ...
    bt = Et.extend({
        addLayer: function (t) {
            return this.hasLayer(t) ? this : (t.addEventParent(this), Et.prototype.addLayer.call(this, t), this.fire("layeradd", {
                layer: t
            }))
        },
        removeLayer: function (t) {
            return this.hasLayer(t) ? (t in this._layers && (t = this._layers[t]), t.removeEventParent(this), Et.prototype.removeLayer.call(this, t), this.fire("layerremove", {
                layer: t
            })) : this
        },
        setStyle: function (t) {
...
var Dt = gt.extend({
        ...
        _getIconUrl: function (t) {
            return typeof Dt.imagePath != "string" && (Dt.imagePath = this._detectIconPath()), (this.options.imagePath || Dt.imagePath) + gt.prototype._getIconUrl.call(this, t)
        },
        ...
        _detectIconPath: function () {
            var t = P("div", "leaflet-default-icon-path", document.body),
                e = Wt(t, "background-image") || Wt(t, "backgroundImage");
    ...
    Mi = st.extend({
        ...
        addHooks: function () {
            ...
            this._draggable || (this._draggable = new dt(t, t, !0)), this._draggable.on({
        ...
        _adjustPan: function (t) {
            ...
            if (!h.contains(s)) {
                ...
                i.panBy(u, {
                    animate: !1
                }), this._draggable._newPos._add(u), this._draggable._startPos._add(u), B(e._icon, this._draggable._newPos), this._onDrag(t), this._panRequest = W(this._adjustPan.bind(this, t))
            }
        },
        ...
        _onPreDrag: function (t) {
            this._marker.options.autoPan && (K(this._panRequest), this._panRequest = W(this._adjustPan.bind(this, t)))
        },
        _onDrag: function (t) {
            var e = this._marker,
                i = e._shadow,
    ...
    Jt = J.extend({
        ...
        setLatLng: function (t) {
            var e = this._latlng;
            return this._latlng = S(t), this.update(), this.fire("move", {
                oldLatLng: e,
                latlng: this._latlng
            })
        },
        ...
        _removeIcon: function () {
            this.options.riseOnHover && this.off({
                mouseover: this._bringToFront,
                mouseout: this._resetZIndex
            }), this.options.autoPanOnFocus && M(this._icon, "focus", this._panOnFocus, this), A(this._icon), this.removeInteractiveTarget(this._icon), this._icon = null
        },
        ...
        _initInteraction: function () {
            if (this.options.interactive && (v(this._icon, "leaflet-interactive"), this.addInteractiveTarget(this._icon), Mi)) {
...
var vt = J.extend({
    ...
    ye = vt.extend({
        ...
        initialize: function (t, e) {
            E(this, e), this._latlng = S(t), this._radius = this.options.radius
        },
        setLatLng: function (t) {
            var e = this._latlng;
            return this._latlng = S(t), this.redraw(), this.fire("move", {
                oldLatLng: e,
                latlng: this._latlng
            })
        },
...
var ui = ye.extend({
    initialize: function (t, e, i) {
        if (typeof e == "number" && (e = T({}, i, {
                radius: e
            })), E(this, e), this._latlng = S(t), isNaN(this.options.radius)) throw new Error("Circle radius cannot be NaN");
...
var ut = vt.extend({
    ...
    closestLayerPoint: function (t) {
        for (var e = 1 / 0, i = null, n = $t, o, s, r = 0, a = this._parts.length; r < a; r++)
    ...
    _convertLatLngs: function (t) {
        for (var e = [], i = Y(t), n = 0, o = t.length; n < o; n++) i ? (e[n] = S(t[n]), this._bounds.extend(e[n])) : e[n] = this._convertLatLngs(t[n]);
        return e
    },
    _project: function () {
        var t = new z;
    ...
    _projectLatlngs: function (t, e, i) {
        ...
        if (n) {
            ...
            for (s = 0; s < o; s++) this._projectLatlngs(t[s], e, i)
    },
    _clipPoints: function () {
        ...
        if (this._parts = [], !(!this._pxBounds || !this._pxBounds.intersects(t))) {
            ...
            for (i = 0, o = 0, s = this._rings.length; i < s; i++)
                for (h = this._rings[i], n = 0, r = h.length; n < r - 1; n++) a = pn(h[n], h[n + 1], t, n, !0), a && (e[o] = e[o] || [], e[o].push(a[0]), (a[1] !== h[n + 1] || n === r - 2) && (e[o].push(a[1]), o++))
        }
    },
    ...
    _containsPoint: function (t, e) {
        ...
        for (i = 0, s = this._parts.length; i < s; i++)
            for (a = this._parts[i], n = 0, r = a.length, o = r - 1; n < r; o = n++)
                if (!(!e && n === 0) && mn(t, a[o], a[n]) <= h) return !0;
        return !1
    }
});
...
var zt = ut.extend({
    ...
    _setLatLngs: function (t) {
        ut.prototype._setLatLngs.call(this, t), Y(this._latlngs) && (this._latlngs = [this._latlngs])
    },
    _defaultShape: function () {
    ...
    _clipPoints: function () {
        ...
        if (t = new z(t.min.subtract(i), t.max.add(i)), this._parts = [], !(!this._pxBounds || !this._pxBounds.intersects(t))) {
            ...
            for (var n = 0, o = this._rings.length, s; n < o; n++) s = yn(this._rings[n], t, !0), s.length && this._parts.push(s)
        }
    },
    _updatePath: function () {
...
function de(t, e) {
    var i = t.type === "Feature" ? t.geometry : t,
        ...
        o = [],
        s = e && e.pointToLayer,
        r = e && e.coordsToLatLng || li,
        a, h, u, l;
    if (!n && !i) return null;
    switch (i.type) {
    case "Point":
        return a = r(n), Oi(s, t, a, e);
    case "MultiPoint":
        for (u = 0, l = n.length; u < l; u++) a = r(n[u]), o.push(Oi(s, t, a, e));
        return new bt(o);
    case "LineString":
    case "MultiLineString":
        return h = _e(n, i.type === "LineString" ? 0 : 1, r), new ut(h, e);
    case "Polygon":
    case "MultiPolygon":
        return h = _e(n, i.type === "Polygon" ? 1 : 2, r), new zt(h, e);
...
function Oi(t, e, i, n) {
    return t ? t(e, i) : new Jt(i, n && n.markersInheritOptions && n)
}
...
function _e(t, e, i) {
    for (var n = [], o = 0, s = t.length, r; o < s; o++) r = e ? _e(t[o], e - 1, i) : (i || li)(t[o]), n.push(r);
    return n
}

function ci(t, e) {
    return t = S(t), t.alt !== void 0 ? [Q(t.lng, e), Q(t.lat, e), Q(t.alt, e)] : [Q(t.lng, e), Q(t.lat, e)]
}

function xe(t, e, i, n) {
    for (var o = [], s = 0, r = t.length; s < r; s++) o.push(e ? xe(t[s], Y(t[s]) ? 0 : e - 1, i, n) : ci(t[s], n));
    return !e && i && o.push(o[0]), o
}

function It(t, e) {
    return t.feature ? T({}, t.feature, {
        geometry: e
    }) : Pe(e)
}
...
var Hs = Ln,
    we = J.extend({
        ...
        initialize: function (t, e, i) {
            this._url = t, this._bounds = R(e), E(this, i)
        },
        onAdd: function () {
        ...
        onRemove: function () {
            A(this._image), this.options.interactive && this.removeInteractiveTarget(this._image)
        },
        setOpacity: function (t) {
        ...
        _initImage: function () {
            ...
            if (v(e, "leaflet-image-layer"), this._zoomAnimated && v(e, "leaflet-zoom-animated"), this.options.className && v(e, this.options.className), e.onselectstart = k, e.onmousemove = k, e.onload = O(this.fire, this, "load"), e.onerror = O(this._overlayOnError, this, "error"), (this.options.crossOrigin || this.options.crossOrigin === "") && (e.crossOrigin = this.options.crossOrigin === !0 ? "" : this.options.crossOrigin), this.options.zIndex && this._updateZIndex(), t) {
                this._url = e.src;
                return
            }
    ...
    bn = we.extend({
        ...
        _initImage: function () {
            ...
            if (v(e, "leaflet-image-layer"), this._zoomAnimated && v(e, "leaflet-zoom-animated"), this.options.className && v(e, this.options.className), e.onselectstart = k, e.onmousemove = k, e.onloadeddata = O(this.fire, this, "load"), t) {
...
var et = J.extend({
    ...
    initialize: function (t, e) {
        t && (t instanceof L.LatLng || $(t)) ? (this._latlng = S(t), E(this, e)) : (E(this, t), this._source = e), this.options.content && (this._content = this.options.content)
    },
    openOn: function (t) {
    ...
    onRemove: function (t) {
        t._fadeAnimated ? (j(this._container, 0), this._removeTimeout = setTimeout(O(A, void 0, this._container), 200)) : A(this._container), this.options.interactive && (I(this._container, "leaflet-interactive"), this.removeInteractiveTarget(this._container))
    },
    getLatLng: function () {
        return this._latlng
    },
...
var Qt = et.extend({
        ...
        onAdd: function (t) {
            et.prototype.onAdd.call(this, t), t.fire("popupopen", {
                ...
                popup: this
            }, !0), this._source instanceof vt || this._source.on("preclick", wt))
        },
        onRemove: function (t) {
            et.prototype.onRemove.call(this, t), t.fire("popupclose", {
                ...
                popup: this
            }, !0), this._source instanceof vt || this._source.off("preclick", wt))
        },
        getEvents: function () {
        ...
        _initLayout: function () {
            ...
            if (this._contentNode = P("div", t + "-content", i), Yt(e), oi(this._contentNode), m(e, "contextmenu", wt), this._tipContainer = P("div", t + "-tip-container", e), this._tip = P("div", t + "-tip", this._tipContainer), this.options.closeButton) {
        ...
        _updateLayout: function () {
            ...
            o && n > o ? (e.height = o + "px", v(t, s)) : I(t, s), this._containerWidth = this._container.offsetWidth
        },
        _animateZoom: function (t) {
        ...
        _adjustPan: function (t) {
            if (this.options.autoPan) {
                ...
                var e = this._map,
                    i = parseInt(Wt(this._container, "marginBottom"), 10) || 0,
                    n = this._container.offsetHeight + i,
                    o = this._containerWidth,
                    s = new p(this._containerLeft, -n - this._containerBottom);
                s._add(Mt(this._container));
                var r = e.layerPointToContainerPoint(s),
                    a = _(this.options.autoPanPadding),
                    h = _(this.options.autoPanPaddingTopLeft || a),
                    u = _(this.options.autoPanPaddingBottomRight || a),
                    l = e.getSize(),
                    f = 0,
                    c = 0;
                r.x + o + u.x > l.x && (f = r.x + o - l.x + u.x), r.x - f - h.x < 0 && (f = r.x - h.x), r.y + n + u.y > l.y && (c = r.y + n - l.y + u.y), r.y - c - h.y < 0 && (c = r.y - h.y), (f || c) && e.fire("autopanstart").panBy([f, c], {
...
x.include({
    openPopup: function (t, e, i) {
        return this._initOverlay(Qt, t, e, i).openOn(this), this
    },
...
J.include({
    bindPopup: function (t, e) {
        return this._popup = this._initOverlay(Qt, this._popup, t, e), this._popupHandlersAdded || (this.on({
...
var Le = et.extend({
        ...
        _initLayout: function () {
            ...
            this._contentNode = this._container = P("div", e), this._container.setAttribute("role", "tooltip"), this._container.setAttribute("id", "leaflet-tooltip-" + w(this))
        },
        _updateLayout: function () {},
        _adjustPan: function () {},
        _setPosition: function (t) {
            var e, i, n = this._map,
                ...
                h = o.offsetWidth,
                u = o.offsetHeight,
                l = _(this.options.offset),
                f = this._getAnchor();
            a === "top" ? (e = h / 2, i = u) : a === "bottom" ? (e = h / 2, i = 0) : a === "center" ? (e = h / 2, i = u / 2) : a === "right" ? (e = 0, i = u / 2) : a === "left" ? (e = h, i = u / 2) : r.x < s.x ? (a = "right", e = 0, i = u / 2) : (a = "left", e = h + (l.x + f.x) * 2, i = u / 2), t = t.subtract(_(e, i, !0)).add(l).add(f), I(o, "leaflet-tooltip-right"), I(o, "leaflet-tooltip-left"), I(o, "leaflet-tooltip-top"), I(o, "leaflet-tooltip-bottom"), v(o, "leaflet-tooltip-" + a), B(o, t)
        },
        _updatePosition: function () {
            var t = this._map.latLngToLayerPoint(this._latlng);
            this._setPosition(t)
...
var Tt = J.extend({
    ...
    onRemove: function (t) {
        this._removeAllTiles(), A(this._container), t._removeZoomLimit(this), this._container = null, this._tileZoom = void 0
    },
    bringToFront: function () {
    ...
    getEvents: function () {
        ...
        return this.options.updateWhenIdle || (this._onMove || (this._onMove = ki(this._onMoveEnd, this.options.updateInterval, this)), t.move = this._onMove), this._zoomAnimated && (t.zoomanim = this._animateZoom), t
    },
    createTile: function () {
    ...
    _setAutoZIndex: function (t) {
        for (var e = this.getPane().children, i = -t(-1 / 0, 1 / 0), n = 0, o = e.length, s; n < o; n++) s = e[n].style.zIndex, e[n] !== this._container && s && (i = t(i, +s));
    ...
    _updateOpacity: function () {
        if (this._map && !d.ielt9) {
            ...
            i && !this._noPrune && this._pruneTiles(), e && (K(this._fadeFrame), this._fadeFrame = W(this._updateOpacity, this))
        }
    },
    _onOpaqueTile: k,
    ...
    _updateLevels: function () {
        ...
        if (t !== void 0) {
            for (var i in this._levels) i = Number(i), this._levels[i].el.children.length || i === t ? (this._levels[i].el.style.zIndex = e - Math.abs(t - i), this._onUpdateLevel(i)) : (A(this._levels[i].el), this._removeTilesAtZoom(i), this._onRemoveLevel(i), delete this._levels[i]);
            var n = this._levels[t],
                o = this._map;
            return n || (n = this._levels[t] = {}, n.el = P("div", "leaflet-tile-container leaflet-zoom-animated", this._container), n.el.style.zIndex = e, n.origin = o.project(o.unproject(o.getPixelOrigin()), t).round(), n.zoom = t, this._setZoomTransform(n, o.getCenter(), o.getZoom()), k(n.el.offsetWidth), this._onCreateLevel(n)), this._level = n, n
        }
    },
    _onUpdateLevel: k,
    _onRemoveLevel: k,
    ...
    _invalidateAll: function () {
        for (var t in this._levels) A(this._levels[t].el), this._onRemoveLevel(Number(t)), delete this._levels[t];
                ...
                for (var f = o.min.y; f <= o.max.y; f++)
                    for (var c = o.min.x; c <= o.max.x; c++) {
                        ...
                        if (g.z = this._tileZoom, !!this._isValidTile(g)) {
                            var N = this._tiles[this._tileCoordsToKey(g)];
                            N ? N.current = !0 : r.push(g)
                        }
                    }
                if (r.sort(function (V, rt) {
                        return V.distanceTo(s) - rt.distanceTo(s)
                    }), r.length !== 0) {
                    this._loading || (this._loading = !0, this.fire("loading"));
                    var G = document.createDocumentFragment();
                    for (c = 0; c < r.length; c++) this._addTile(r[c], G);
    ...
    _removeTile: function (t) {
        var e = this._tiles[t];
        e && (A(e.el), delete this._tiles[t], this.fire("tileunload", {
            tile: e.el,
    ...
    _initTile: function (t) {
        ...
        t.style.width = e.x + "px", t.style.height = e.y + "px", t.onselectstart = k, t.onmousemove = k, d.ielt9 && this.options.opacity < 1 && j(t, this.options.opacity)
    },
    _addTile: function (t, e) {
        var i = this._getTilePos(t),
            n = this._tileCoordsToKey(t),
            o = this.createTile(this._wrapCoords(t), O(this._tileReady, this, t));
        this._initTile(o), this.createTile.length < 2 && W(O(this._tileReady, this, t, null, o)), B(o, i), this._tiles[n] = {
            el: o,
            coords: t,
            current: !0
    ...
    _tileReady: function (t, e, i) {
        ...
        i = this._tiles[n], i && (i.loaded = +new Date, this._map._fadeAnimated ? (j(i.el, 0), K(this._fadeFrame), this._fadeFrame = W(this._updateOpacity, this)) : (i.active = !0, this._pruneTiles()), e || (v(i.el, "leaflet-tile-loaded"), this.fire("tileload", {
            tile: i.el,
            coords: t
        })), this._noTilesToLoad() && (this._loading = !1, this.fire("load"), d.ielt9 || !this._map._fadeAnimated ? W(this._pruneTiles, this) : setTimeout(O(this._pruneTiles, this), 250)))
    },
    _getTilePos: function (t) {
        return t.scaleBy(this.getTileSize()).subtract(this._level.origin)
    },
    _wrapCoords: function (t) {
        var e = new p(this._wrapX ? Ht(t.x, this._wrapX) : t.x, this._wrapY ? Ht(t.y, this._wrapY) : t.y);
        return e.z = t.z, e
    },
...
var Ct = Tt.extend({
    ...
    createTile: function (t, e) {
        ...
        return m(i, "load", O(this._tileOnLoad, this, e, i)), m(i, "error", O(this._tileOnError, this, e, i)), (this.options.crossOrigin || this.options.crossOrigin === "") && (i.crossOrigin = this.options.crossOrigin === !0 ? "" : this.options.crossOrigin), typeof this.options.referrerPolicy == "string" && (i.referrerPolicy = this.options.referrerPolicy), i.alt = "", i.src = this.getTileUrl(t), i
    },
    getTileUrl: function (t) {
        ...
        return Ni(this._url, T(e, this.options))
    },
    _tileOnLoad: function (t, e) {
        d.ielt9 ? setTimeout(O(t, this, null, e), 0) : t(null, e)
    },
    ...
    _abortLoading: function () {
        ...
        for (t in this._tiles)
            if (this._tiles[t].coords.z !== this._tileZoom && (e = this._tiles[t].el, e.onload = k, e.onerror = k, !e.complete)) {
                ...
                A(e), delete this._tiles[t], this.fire("tileabort", {
                    tile: e,
                    coords: i
                })
            }
    ...
    _removeTile: function (t) {
        var e = this._tiles[t];
        if (e) return e.el.setAttribute("src", se), Tt.prototype._removeTile.call(this, t)
    },
    _tileReady: function (t, e, i) {
        if (!(!this._map || i && i.getAttribute("src") === se)) return Tt.prototype._tileReady.call(this, t, e, i)
    }
});
...
var Mn = Ct.extend({
    ...
    initialize: function (t, e) {
        ...
        e = E(this, e);
        var o = e.detectRetina && d.retina ? 2 : 1,
            s = this.getTileSize();
    ...
    getTileUrl: function (t) {
        var e = this._tileCoordsToNwSe(t),
            ...
            o = n.min,
            s = n.max,
            r = (this._wmsVersion >= 1.3 && this._crs === wn ? [o.y, o.x, s.y, s.x] : [o.x, o.y, s.x, s.y]).join(","),
            a = Ct.prototype.getTileUrl.call(this, t);
        return a + Bi(this.wmsParams, a, this.options.uppercase) + (this.options.uppercase ? "&BBOX=" : "&bbox=") + r
    },
...
var ht = J.extend({
        ...
        initialize: function (t) {
            E(this, t), w(this), this._layers = this._layers || {}
        },
        onAdd: function () {
        ...
        _updateTransform: function (t, e) {
            ...
            d.any3d ? St(this._container, s, i) : B(this._container, s)
        },
        _reset: function () {
    ...
    On = ht.extend({
        ...
        _destroyContainer: function () {
            K(this._redrawRequest), delete this._ctx, A(this._container), M(this._container), delete this._container
        },
        _updatePaths: function () {
        ...
        _update: function () {
            if (!(this._map._animatingZoom && this._bounds)) {
                ...
                var t = this._bounds,
                    ...
                    i = t.getSize(),
                    n = d.retina ? 2 : 1;
                B(e, t.min), e.width = n * i.x, e.height = n * i.y, e.style.width = i.x + "px", e.style.height = i.y + "px", d.retina && this._ctx.scale(2, 2), this._ctx.translate(-t.min.x, -t.min.y), this.fire("update")
            }
        },
        _reset: function () {
        ...
        _handleMouseHover: function (t, e) {
            if (!this._mouseHoverThrottled) {
                ...
                n !== this._hoveredLayer && (this._handleMouseOut(t), n && (v(this._container, "leaflet-interactive"), this._fireEvent([n], t, "mouseover"), this._hoveredLayer = n)), this._fireEvent(this._hoveredLayer ? [this._hoveredLayer] : !1, t), this._mouseHoverThrottled = !0, setTimeout(O(function () {
...
var Nt = function () {
    ...
    Ys = {
        ...
        _initPath: function (t) {
            var e = t._container = Nt("shape");
            v(e, "leaflet-vml-shape " + (this.options.className || "")), e.coordsize = "1 1", t._path = Nt("path"), e.appendChild(t._path), this._updateStyle(t), this._layers[w(t)] = t
        },
        _addPath: function (t) {
            var e = t._container;
        ...
        _removePath: function (t) {
            var e = t._container;
            A(e), t.removeInteractiveTarget(e), delete this._layers[w(t)]
        },
        _updateStyle: function (t) {
            var e = t._stroke,
                i = t._fill,
                n = t.options,
                o = t._container;
            o.stroked = !!n.stroke, o.filled = !!n.fill, n.stroke ? (e || (e = t._stroke = Nt("stroke")), o.appendChild(e), e.weight = n.weight + "px", e.color = n.color, e.opacity = n.opacity, n.dashArray ? e.dashStyle = $(n.dashArray) ? n.dashArray.join(" ") : n.dashArray.replace(/( *, *)/g, " ") : e.dashStyle = "", e.endcap = n.lineCap.replace("butt", "flat"), e.joinstyle = n.lineJoin) : e && (o.removeChild(e), t._stroke = null), n.fill ? (i || (i = t._fill = Nt("fill")), o.appendChild(i), i.color = n.fillColor || n.color, i.opacity = n.fillOpacity) : i && (o.removeChild(i), t._fill = null)
        },
        _updateCircle: function (t) {
    ...
    te = ht.extend({
        ...
        _destroyContainer: function () {
            A(this._container), M(this._container), delete this._container, delete this._rootGroup, delete this._svgSize
        },
        _update: function () {
            if (!(this._map._animatingZoom && this._bounds)) {
                ht.prototype._update.call(this);
        ...
        _initPath: function (t) {
            ...
            t.options.className && v(e, t.options.className), t.options.interactive && v(e, "leaflet-interactive"), this._updateStyle(t), this._layers[w(t)] = t
        },
        _addPath: function (t) {
            this._rootGroup || this._initContainer(), this._rootGroup.appendChild(t._path), t.addInteractiveTarget(t._path)
        },
        _removePath: function (t) {
            A(t._path), t.removeInteractiveTarget(t._path), delete this._layers[w(t)]
        },
        _updatePath: function (t) {
...
function An(t) {
    return d.svg || d.vml ? new te(t) : null
}
x.include({
    ...
    _createRenderer: function (t) {
        return this.options.preferCanvas && En(t) || An(t)
    }
});
var zn = zt.extend({
    initialize: function (t, e) {
    ...
    _boundsToLatLngs: function (t) {
        return t = R(t), [t.getSouthWest(), t.getNorthWest(), t.getNorthEast(), t.getSouthEast()]
    }
});
...
te.create = he;
te.pointsToPath = Fi;
ct.geometryToLayer = de;
ct.coordsToLatLng = li;
ct.coordsToLatLngs = _e;
ct.latLngToCoords = ci;
ct.latLngsToCoords = xe;
ct.getFeature = It;
ct.asFeature = Pe;
x.mergeOptions({
    boxZoom: !0
...
var In = st.extend({
    ...
    _onMouseDown: function (t) {
        ...
        this._clearDeferredResetState(), this._resetState(), Ut(), ti(), this._startPoint = this._map.mouseEventToContainerPoint(t), m(document, {
            contextmenu: Ot,
    ...
    _finish: function () {
        this._moved && (A(this._box), I(this._container, "leaflet-crosshair")), Gt(), ei(), M(document, {
            contextmenu: Ot,
            mousemove: this._onMouseMove,
            mouseup: this._onMouseUp,
            keydown: this._onKeyDown
    ...
    _onMouseUp: function (t) {
        if (!(t.which !== 1 && t.button !== 1) && (this._finish(), !!this._moved)) {
            ...
            var e = new U(this._map.containerPointToLatLng(this._startPoint), this._map.containerPointToLatLng(this._point));
...
x.addInitHook("addHandler", "boxZoom", In);
x.mergeOptions({
    doubleClickZoom: !0
});
var Zn = st.extend({
...
x.addInitHook("addHandler", "doubleClickZoom", Zn);
x.mergeOptions({
    dragging: !0,
    inertia: !0,
...
var kn = st.extend({
    addHooks: function () {
        if (!this._draggable) {
            var t = this._map;
            this._draggable = new dt(t._mapPane, t._container), this._draggable.on({
                dragstart: this._onDragStart,
                drag: this._onDrag,
                dragend: this._onDragEnd
    ...
    _onDragEnd: function (t) {
        ...
        if (e.fire("dragend", t), n) e.fire("moveend");
            ...
            var o = this._lastPos.subtract(this._positions[0]),
                ...
                c = l.multiplyBy(-f / 2).round();
            !c.x && !c.y ? e.fire("moveend") : (c = e._limitOffset(c, e.options.maxBounds), W(function () {
                e.panBy(c, {
                    duration: f,
                    easeLinearity: r,
                    noMoveStart: !0,
...
x.addInitHook("addHandler", "dragging", kn);
x.mergeOptions({
    keyboard: !0,
    keyboardPanDelta: 80
});
    ...
    _onKeyDown: function (t) {
        if (!(t.altKey || t.ctrlKey || t.metaKey)) {
            var e = t.keyCode,
                i = this._map,
                n;
            if (e in this._panKeys)(!i._panAnim || !i._panAnim._inProgress) && (n = this._panKeys[e], t.shiftKey && (n = _(n).multiplyBy(3)), i.panBy(n), i.options.maxBounds && i.panInsideBounds(i.options.maxBounds));
...
x.addInitHook("addHandler", "keyboard", Bn);
x.mergeOptions({
    scrollWheelZoom: !0,
...
var Nn = st.extend({
    ...
    _onWheelScroll: function (t) {
        ...
        clearTimeout(this._timer), this._timer = setTimeout(O(this._performZoom, this), n), Ot(t)
    },
...
x.addInitHook("addHandler", "scrollWheelZoom", Nn);
var $s = 600;
x.mergeOptions({
...
var Rn = st.extend({
    ...
    _onDown: function (t) {
        if (clearTimeout(this._holdTimeout), t.touches.length === 1) {
            var e = t.touches[0];
            this._startPos = this._newPos = new p(e.clientX, e.clientY), this._holdTimeout = setTimeout(O(function () {
                this._cancel(), this._isTapValid() && (m(document, "touchend", H), m(document, "touchend touchcancel", this._cancelClickPrevent), this._simulateEvent("contextmenu", e))
            }, this), $s), m(document, "touchend touchcancel contextmenu", this._cancel, this), m(document, "touchmove", this._onMove, this)
        }
    },
    _cancelClickPrevent: function t() {
        M(document, "touchend", H), M(document, "touchend touchcancel", t)
    },
    _cancel: function () {
...
x.addInitHook("addHandler", "tapHold", Rn);
x.mergeOptions({
    touchZoom: d.touch,
...
var Dn = st.extend({
    ...
    removeHooks: function () {
        I(this._map._container, "leaflet-touch-zoom"), M(this._map._container, "touchstart", this._onTouchStart, this)
    },
    ...
    _onTouchMove: function (t) {
        if (!(!t.touches || t.touches.length !== 2 || !this._zooming)) {
            ...
            this._animRequest = W(r, this, !0), H(t)
        }
    },
    _onTouchEnd: function () {
        ...
        this._zooming = !1, K(this._animRequest), M(document, "touchmove", this._onTouchMove, this), M(document, "touchend touchcancel", this._onTouchEnd, this), this._map.options.zoomAnimation ? this._map._animateZoom(this._center, this._map._limitZoom(this._zoom), !0, this._map.options.zoomSnap) : this._map._resetView(this._center, this._map._limitZoom(this._zoom))
    }
});
x.addInitHook("addHandler", "touchZoom", Dn);
x.BoxZoom = In;
x.DoubleClickZoom = Zn;
x.Drag = kn;
x.Keyboard = Bn;
x.ScrollWheelZoom = Nn;
x.TapHold = Rn;
x.TouchZoom = Dn;
var Js = {
        __proto__: null,
...
function mi(t, e) {
    return e == null ? function (n, o) {
        const s = b.useRef();
        return s.current || (s.current = t(n, o)), s
    } : function (n, o) {
        const s = b.useRef();
        s.current || (s.current = t(n, o));
        const r = b.useRef(n),
            {
                instance: a
            } = s.current;
        return b.useEffect(function () {
            r.current !== n && (e(a, n, r.current), r.current = n)
        }, [a, n, o]), s
    }
}
...
function ir(t, e) {
    b.useEffect(function () {
        return (e.layerContainer ?? e.map).addLayer(t.instance),
            function () {
                var s;
                (s = e.layerContainer) == null || s.removeLayer(t.instance), e.map.removeLayer(t.instance)
            }
    }, [e, t])
}
...
function Fn(t) {
    return function (i) {
        const n = Fe(),
            o = t(We(i, n), n);
        return Ei(n.map, i.attribution), Ii(o.current, i.eventHandlers), ir(o.current, n), o
    }
}
...
function rr(t, e, i) {
    ...
    n != null && n !== i.opacity && t.setOpacity(n), o != null && o !== i.zIndex && t.setZIndex(o)
}
...
function hr({
    ...
    b.useImperativeHandle(f, () => (g == null ? void 0 : g.map) ?? null, [g]);
    const G = b.useCallback(rt => {
        if (rt !== null && g === null) {
            const at = new x(rt, l);
            i != null && u != null ? at.setView(i, u) : t != null && at.fitBounds(t, e), h != null && at.whenReady(h), N(Mo(at))
        }
    }, []);
    b.useEffect(() => () => {
        g == null || g.map.remove()
    }, [g]);
    const V = g ? Ce.createElement(zi, {
        value: g
    }, n) : r ?? null;
    return Ce.createElement("div", Ne({}, c, {
        ref: G
    }), V)
}
const ur = b.forwardRef(hr),
    Wn = nr(function ({
        position: e,
        ...i
    }, n) {
        ...
        i.position !== n.position && e.setLatLng(i.position), i.icon != null && i.icon !== n.icon && e.setIcon(i.icon), i.zIndexOffset != null && i.zIndexOffset !== n.zIndexOffset && e.setZIndexOffset(i.zIndexOffset), i.opacity != null && i.opacity !== n.opacity && e.setOpacity(i.opacity), e.dragging != null && i.draggable !== n.draggable && (i.draggable === !0 ? e.dragging.enable() : e.dragging.disable())
    }),
    lr = or(function (e, i) {
        const n = new Qt(e, i.overlayContainer);
        return _i(n, i)
    }, function (e, i, {
        position: n
    }, o) {
        b.useEffect(function () {
            ...
            return i.map.on({
                    popupopen: a,
                    popupclose: h
                }), i.overlayContainer == null ? (n != null && r.setLatLng(n), r.openOn(i.map)) : i.overlayContainer.bindPopup(r),
                function () {
                    var l;
                    i.map.off({
                        popupopen: a,
                        popupclose: h
                    }), (l = i.overlayContainer) == null || l.unbindPopup(), i.map.removeLayer(r)
                }
        }, [e, i, o, n])
    }),
    cr = sr(function ({
    ...
    xt = {
        ...
        cayoPerico: {
            ...
            tileServer: "https://assets.loaf-scripts.com/map-tiles/gtav/cayo-perico/{layer}/{z}/{x}/{y}.jpg",
            defaultCenter: [-5150, 4700],
            defaultZoom: 2
        }
    },
    it = {
        LOS_SANTOS: "losSantos",
        CAYO_PERICO: "cayoPerico"
    },
    fr = T({}, ot.Simple, {
        projection: Pn.LonLat,
        initialize: function (t) {
            const e = t.image,
                i = t.topLeft,
                n = t.bottomRight,
                o = 256;
            this.wrapLng = [i[0], n[0]], this.wrapLat = [n[1], i[1]];
            const s = Math.ceil(Math.log(Math.max(e[0], e[1]) / o) / Math.log(2)),
                r = n[0] - i[0],
                a = n[1] - i[1];
            if (r === 0 || a === 0) {
                console.error("Invalid map config: gameWidth or gameHeight_CRS is zero.", t), this.transformation = new Ft(1, 0, -1, 0), this.options = {
                    tileSize: o
                }, this._maxZoom = 0;
                return
            }
            const h = Math.pow(2, s),
                ...
                g = -f * i[0],
                N = -c * i[1];
            this.transformation = new Ft(f, g, c, N), this.options = {
                tileSize: o
            }, this._mapConfig = t, this._maxZoom = s
        },
        scale: function (t) {
            return Math.pow(2, t)
        },
    ...
    Un = (t = it.LOS_SANTOS) => {
        const e = xt[t];
        if (!e) return console.error(`Invalid map type: ${t}`), null;
        const i = Object.assign(Object.create(fr), {});
        return i.initialize(e), i
    },
    Gn = Un(it.LOS_SANTOS),
    Vn = Un(it.CAYO_PERICO),
    qn = (t = it.LOS_SANTOS) => {
        const e = xt[t];
        return e ? [
            [e.bottomRight[1], e.topLeft[0]],
            [e.topLeft[1], e.bottomRight[0]]
        ] : (console.error(`Invalid map type: ${t}`), [
            [0, 0],
            [0, 0]
        ])
    },
    Re = {
        mapTypes: {
            losSantos: {
                maxZoom: Gn._maxZoom || 6,
                initialZoom: xt.losSantos.defaultZoom,
                minZoom: 2,
                defaultCenter: xt.losSantos.defaultCenter
            },
            cayoPerico: {
                maxZoom: Vn._maxZoom || 6,
                initialZoom: xt.cayoPerico.defaultZoom,
                minZoom: 0,
                defaultCenter: xt.cayoPerico.defaultCenter
            }
        },
        mapStyles: {
            render: "render",
    ...
    xr = ({
        ...
        const i = qn(it.LOS_SANTOS);
        return t > i[0][0] && t < i[1][0] && e > i[0][1] && e < i[1][1]
    },
    dr = (t, e) => new gt({
        iconUrl: t ?? "./assets/img/icons/maps/mappin.png",
        popupAnchor: [-0, -0],
        iconSize: e ?? [25, 25]
    }),
    _r = () => new gt({
        iconUrl: "./assets/img/icons/maps/pin.svg",
        popupAnchor: [-0, -0],
        iconSize: [25, 25]
    });
const me = He(localStorage.getItem("lb-active-map-type") ?? Re.mapStyles.render),
    De = He(it.LOS_SANTOS),
    Vt = He([0, 0]);
...
function mr() {
    ...
    b.useEffect(() => {
        ...
        (async () => {
            yt("Maps", {
                ...
                const N = (e == null ? void 0 : e.data) && {
                        ...
                        name: (rt = e.data) == null ? void 0 : rt.name,
                        icon: (at = e.data) == null ? void 0 : at.icon,
                        description: (ee = e.data) == null ? void 0 : ee.description,
                        size: [35, 35]
                    },
                    G = [];
                let V = 0;
                if (!(t != null && t.locations) || t.locations.length === 0) return s([...g, N]);
                t == null || t.locations.forEach(ft => {
                    Qn(ft.icon, ie => {
                        G.push({
                            position: [ft.position.y, ft.position.x],
                            name: ft.name,
                            description: ft.description,
                            icon: ie ? ft.icon : "./assets/img/icons/maps/mappin.png"
                        }), V++, V === t.locations.length && s([...g, N, ...G].filter(Boolean))
                    })
                })
            })
        })()
        ...
        if (vi("Maps")) {
            if ((window == null ? void 0 : window.chrome) !== void 0) {
                const c = Tt.prototype._initTile;
                Tt.include({
                    _initTile: function (g) {
                        c.call(this, g);
                        const N = this.getTileSize();
                        g.style.width = `${N.x+1}px`, g.style.height = `${N.y+1}px`
                    }
                })
            }
            return yt("Maps", {
    ...
    return mt("div", {
        ...
        children: [y("div", {
            ...
            children: mt(ur, {
                className: "map",
                style: {
                    backgroundColor: Re.backgrounds[n]
                },
                crs: i === it.LOS_SANTOS ? Gn : Vn,
                center: [((l = Vt.value) == null ? void 0 : l[0]) || a.defaultCenter[0], ((f = Vt.value) == null ? void 0 : f[1]) || a.defaultCenter[1]],
                zoom: a.initialZoom,
                minZoom: a.minZoom,
                maxZoom: a.maxZoom,
                bounceAtZoomLimits: !0,
                ...
                boxZoom: !1,
                children: [y(vr, {}), y(cr, {
                    url: xt[i].tileServer.replace("{layer}", n),
                    minZoom: a.minZoom,
                    maxZoom: a.maxZoom,
                    maxNativeZoom: a.maxZoom,
                    noWrap: !0
                }, `${i}-${n}`), o.map((c, g) => c ? y(Wn, {
                    position: c.position,
                    icon: dr(c.icon),
                    children: y(lr, {
                        children: mt("div", {
                            ...
                            children: [y("div", {
                                ...
                                className: "button",
                                onClick: () => r(c.position),
                                children: D("APPS.MAPS.GO")
                            })]
                        })
                    })
                }, g) : null), 
...
const pr = () => {
        const t = _t(Vt),
            e = _r();
        return to("maps:updateCoords", i => {
            if (i && !((i == null ? void 0 : i.x) === t[1] && (i == null ? void 0 : i.y) === t[0])) {
                if (!eo()) return io("info", "Airplane mode is enabled, can't update coords");
                Vt.set([i.y, i.x])
            }
        }), !t.includes(0, 1) && y(Wn, {
            position: t,
    ...
    gr = ({
        ...
        const [n, o] = b.useState(!1), [s, r] = b.useState(""), a = {
            person: y(uo, {}),
            bag: y(lo, {}),
            bed: y(co, {}),
            business: y(fo, {}),
                    ...
                    children: mt("div", {
                        ...
                        children: [mt("div", {
                            ...
                            children: [y(so, {
                                onClick: () => {
                                    oe.PopUp.set({
                                        title: D("APPS.MAPS.ADD_LOCATION_POPUP.TITLE"),
                                        description: D("APPS.MAPS.ADD_LOCATION_POPUP.DESCRIPTION"),
                                        input: {
                                            placeholder: D("APPS.MAPS.ADD_LOCATION_POPUP.PLACEHOLDER"),
                                            minCharacters: 3,
                                            maxCharacters: 16,
                                            type: "text",
                                            onChange: h => r(h)
                                        ...
                                        buttons: [{
                                            title: D("APPS.MAPS.ADD_LOCATION_POPUP.CANCEL"),
                                            cb: () => r("")
                                        }, {
                                            title: D("APPS.MAPS.ADD_LOCATION_POPUP.PROCEED"),
                                            cb: () => {
                                                r(h => (yt("Maps", {
                                                    action: "addLocation",
                                                    name: h
                                ...
                                className: "name",
                                children: D("APPS.MAPS.ADD")
                            })]
                        }), t && t.filter(h => h && h.id).map((h, u) => mt("div", {
                            className: "location",
                            onClick: () => {
                                oe.ContextMenu.set({
                                    buttons: [{
                                        title: D("APPS.MAPS.SET_WAYPOINT"),
                                        cb: () => i(h.position)
                                    }, {
                                        title: D("APPS.MAPS.CHANGE_NAME_POPUP.TITLE"),
                                        cb: () => {
                                            oe.PopUp.set({
                                                title: D("APPS.MAPS.CHANGE_NAME_POPUP.TITLE"),
                                                description: D("APPS.MAPS.CHANGE_NAME_POPUP.DESCRIPTION"),
                                                input: {
                                                    placeholder: D("APPS.MAPS.CHANGE_NAME_POPUP.PLACEHOLDER"),
                                                    defaultValue: h.name,
                                                    minCharacters: 3,
                                                    maxCharacters: 20,
                                                    onChange: l => r(l)
                                                ...
                                                buttons: [{
                                                    title: D("APPS.MAPS.CHANGE_NAME_POPUP.CANCEL")
                                                }, {
                                                    title: D("APPS.MAPS.CHANGE_NAME_POPUP.PROCEED"),
                                                    cb: () => {
                                                        r(l => (yt("Maps", {
                                                            ...
                                                            f && e(c => {
                                                                const g = [...c],
                                                                    N = g.findIndex(G => (G == null ? void 0 : G.id) === h.id);
                                                                return g[N].name = l, g
                                                            })
                                                        }), l))
                                                    }
                                        ...
                                        cb: () => {
                                            yt("Maps", {
                                                ...
                                                l && e(f => f.filter(c => (c == null ? void 0 : c.id) !== h.id))
                                            })
                                        }
                                    }]
                                })
                            },
                            children: [(a == null ? void 0 : a[h == null ? void 0 : h.icon]) || a.default, y("div", {
                                className: "name",
                                children: h.name
                            }), y("div", {
                                className: "action",
                                children: D("APPS.MAPS.EDIT")
                            })]
                        }, u))]
                    })
                })
    ...
    vr = () => {
        const t = ar(),
            ...
            o = ["render", "game", "print"],
            s = () => {
                const h = (o.indexOf(i) + 1) % o.length;
                me.set(o[h]), localStorage.setItem("lb-active-map-type", o[h])
            },
            r = () => {
                const a = n === it.LOS_SANTOS ? it.CAYO_PERICO : it.LOS_SANTOS;
                De.set(a)
            };
        return mt("div", {
            className: "options",
...
export {
    me as A, Vn as C, Re as D, Gn as L, ur as M, cr as T, xt as a, Wn as b, dr as c, Pr as d, qn as g, xr as i
};